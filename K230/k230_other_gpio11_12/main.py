"""K230 OpenCV steel-ball detector and UART2 position transmitter."""
...
# Fixed pipe ROI measured from the current camera installation.
...
# Alternate K230 UART2 wiring:
# GPIO11/TX -> Tianmengxing PB7/RX
# GPIO12/RX <- Tianmengxing PB6/TX
UART2_TX_PIN = 11
UART2_RX_PIN = 12
...
def find_best_circle(image_array, roi_y0, roi_y1):
    ...
    # Slice only the first axis so both 2-D and 3-D CanMV ndarray views work.
    ...
    # Firmware variants return (N,3), (N,1,3), or (1,N,3).
    ...
    for index in range(circle_count):
        ...
        # Drawing and following calculations use one fixed steel-ball radius.
        radius = FIXED_RADIUS
